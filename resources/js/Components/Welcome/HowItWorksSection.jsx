...
export default function HowItWorksSection({ t, content, lang }) {
    // Determine source data
    const sectionData = content ? content[lang] : t.howItWorks;
                    ...
                    {sectionData.steps.map((step, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center group hover:border-indigo-500/30 transition duration-300 h-full">
