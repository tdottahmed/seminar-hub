...
export default function Edit({ auth, program }) {
    const { data, setData, put, processing, errors } = useForm({
        title: program.title || { en: '', bn: '' },
        description: program.description || { en: '', bn: '' },
        count_label: program.count_label || { en: '', bn: '' },
        icon: program.icon || 'Activity',
        color_class: program.color_class || 'bg-indigo-500',
    ...
    return (
        <AdminLayout user={auth.user} title="Edit Program">
