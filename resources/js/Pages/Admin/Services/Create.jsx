...
export default function Create({ auth }) {
    ...
    return (
        <AdminLayout user={auth.user} title="Create Service">
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-slate-800">Create Service</h2>
                            <p className="text-slate-500">Add a new service to your offering.</p>
                        </div>
                    </div>
