...
export default function Edit({ auth, event, quiz }) {
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Quiz: {quiz.title}</h2>}
        >
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="block mt-4">
                                    <label className="flex items-center">
                                        ...
                                        />
                                        <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Published</span>
                                    </label>
                                </div>
