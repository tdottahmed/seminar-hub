...
export default function Create({ auth }) {
    ...
    return (
        <AdminLayout user={auth.user} title="Create Team Member">
            ...
            <div className="max-w-3xl mx-auto">
                <div className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800">New Team Member</h2>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                    <form onSubmit={submit} className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel htmlFor="is_team_lead" value="Team Lead" />
                                <div className="mt-2 flex items-center gap-3">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            type="checkbox"
                                            checked={data.is_team_lead}
                                            onChange={(e) => setData("is_team_lead", e.target.checked)}
                                ...
                                <InputError message={errors.is_team_lead} className="mt-2" />
                            </div>
                            <div>
