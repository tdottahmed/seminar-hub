...
export default function Registration({ event }) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col lg:flex-row font-sans text-slate-200">
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white relative overflow-hidden lg:h-screen lg:sticky lg:top-0 p-8 lg:p-16 flex flex-col justify-center">
                 {/* Background Effects */}
